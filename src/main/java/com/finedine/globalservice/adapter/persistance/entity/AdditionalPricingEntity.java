...
@Entity
@Data
@Table(name = "additional_pricing")
public class AdditionalPricingEntity {

    @Id
    @Column(name = "additional_pricing_id")
    ...
    public void prePersist() {
        ...
        this.additionalPricingId = generateHash(this.createdAt.toString());
    }
